...
class AdversarialAutoencoder():
    ...
    def save_imgs(self, epoch, imgs):
        ...
        for i in range(r):
            for j in range(c):
                ...
                axs[i,j].axis('off')
                cnt += 1
        fig.savefig("drive/RACE/gan_ae_mnist_%d.png" % epoch)
        plt.close()
    ...
    def save_model(self):
        ...
        save(self.encoder, "gan_ae_decoder_mnist")
        save(self.decoder, "gan_ae_decoder_mnist")

if __name__ == '__main__':
    aae = AdversarialAutoencoder()
    #aae.train(epochs=20000, batch_size=32, save_interval=200)
    aae.train(epochs=500, batch_size=32, save_interval=100)